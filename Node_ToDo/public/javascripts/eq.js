...
// js 에서는 false 경우가 몇가지 잇는데
// 비교연산자, 관계연산자와 연결했을떄 false값을 갖는 친구들
b = "" || null || undefined || NaN || 0 || "없음";
console.log(b);

// 어떤(변수에 저장된) 값을 비교하여 정확히 일치하는지 알고싶을떄는
...
console.log("num && ++num;", num); //andalso
if (num || ++num) {
}
console.log("num || ++num", num); // orelse
